...
//     // restau.map((restaurant,index) =>{
//     //     stars=[];
//     //     var fullFood = Math.floor(restaurant.foodRating);
//     //     var fullMood = Math.floor(restaurant.foodRating);
//     //     var fullFood = Math.floor(restaurant.foodRating);
//     //     var fullFood = Math.floor(restaurant.foodRating);
//     //     for(var i=0; i<fullFood; i++){
//     //         foodStars.push(<FontAwesome name="star"/>);
//     //     }
//     //     for(var i=0; i<fullStars; i++){
//     //         foodStars.push(<FontAwesome name="star"/>);
//     //     }
...
//     //         foodStars.push(<FontAwesome name="star"/>);
//     //     }
//     //     priceStars.push(<FontAwesome name="star"/>);
//     //     staffStars.push(<FontAwesome name="star"/>);
//     //     moodStars.push(<FontAwesome name="star"/>);
//     //
//     //     foodRatings.push(foodStars);
//     //     moodRatings.push(priceStars);
//     //     staffRatings.push(staffStars);
//     //     priceRatings.push(moodStars);
//     // });
//
//     return(
//
...
//                           <div className="row">
//                                 <div className="col-md-6">
//                                     <p className="card-text">Food: {
//                                         foodRatings[index]
//                                     }</p>
//                                 </div>
//                                 <div className="col-md-6">
//                                   <p className="card-text">Price: {restaurant.priceRating}</p>
//                                 </div>
//                           </div>
//                           <div className="row">
//                                 <div className="col-md-6">
//                                     <p className="card-text">Mood: {restaurant.moodRating}</p>
//                                 </div>
//                                 <div className="col-md-6">
//                                   <p className="card-text">Staff: {restaurant.staffRating}</p>
//                                 </div>
//                           </div>
//                         </div>
//                     </div>
